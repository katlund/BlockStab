function [QQ, RR] = bcgs(XX, s, IOstr, verbose)
% [QQ, RR] = BCGS(XX, s, IOstr, verbose) performs Block Classical Gram-Schmidt on
% the m x n matrix XX with p = n/s block partitions each of size s with
% inner orthogonalization procedure determined by IOstr.  BCGS is the block
