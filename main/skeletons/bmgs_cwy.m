function [QQ, RR, TT] = bmgs_cwy(XX, s, musc, param)
% [QQ, RR, TT] = BMGS_CWY(XX, s, musc, param) performs Block Modified
...
[QQ(:,kk), RR(kk,kk), TT(kk,kk)] = IntraOrtho(Q_tmp, musc, param);
