function [QQ, RR] = bcgs_irp2(XX, s, musc, param)
% BCGS with twice InnerProd + InnerProd in each loop.
...
for k = 1:p-1
    ...
    RR(1:sk,kk) = RR1 + RR2 + RR(1:sk,kk) * RR(kk,kk);
