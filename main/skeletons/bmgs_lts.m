function [QQ, RR, TT] = bmgs_lts(XX, s, musc, verbose)
% [QQ, RR, TT] = BMGS_LTS(XX, s, musc, verbose) performs Block Modified
...
% procedure determined by musc. BMGS_LTS is the block generalization of
% MGS_LTS.
%
...
for k = 1:p-1
    ...
    [QQ(:,kk), RR(kk,kk), TT(kk,kk)] = IntraOrtho(W, musc);
    TT(1:sk,kk) = InnerProd(QQ(:,1:sk), QQ(:,kk), musc) * TT(kk,kk);
