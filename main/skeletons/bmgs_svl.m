function [QQ, RR, TT] = bmgs_svl(XX, s, IOstr, verbose)
% [QQ, RR, TT] = BMGS_SVL(XX, s, IOstr, verbose) performs Block Modified
...
% orthogonalization procedure determined by IOstr.  When IOstr = 'HouseQR',
% this algorithm reproduces BMGS_H from [Barlow 2019], and when IOstr =
...
for k = 1:p-1
    ...
    TT(1:sk,kk) = -TT(1:sk,1:sk)*...
        InnerProd(QQ(:,1:sk), QQ(:,kk), IOstr) * TT(kk,kk);
