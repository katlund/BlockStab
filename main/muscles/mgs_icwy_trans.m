function [Q, R, T] = mgs_icwy_trans(X)
% [Q, R, T] = MGS_ICWY_TRANS(X) performs an unstable Modified Gram-Schmidt
% with Inverse Compact WY form on the m x s matrix X.
