function [Q, R, T] = mgs_cwy(X, verbose)
% [Q, R, T] = MGS_CWY(X, verbose) performs Modified Gram-Schmidt with
% Compact WY form on the m x s matrix X. Same as Algorithm 6 from
