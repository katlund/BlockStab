...
save(save_str, 'condXX', 'config_file', 'dtnow', 'dir_str', 'lgd',...
    'loss_ortho', 'mat_type', 'musc', 'normXX', 'options', 'param',...
    'rel_chol_res', 'rel_res', 'skel', 'alg_cmap', 'symb');
if nargout == 1
    run_data = load(save_str);
end
