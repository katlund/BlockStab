function gen_plots_mp(prec, run_data, new_dir_str)
...
plot(ax{1}, run_data.condXX, epsm*run_data.condXX, 'k--', run_data.condXX, epsm*(run_data.condXX.^2), 'k-', run_data.condXX, epsm, 'k.')
plot(ax{3}, run_data.condXX, epsm*run_data.condXX, 'k--', run_data.condXX, epsm*(run_data.condXX.^2), 'k-', run_data.condXX, epsm, 'k.')
